...
![私人空间版工作区与西汉示例](https://raw.githubusercontent.com/mulspace/ftree/main/docs/images/workspace-overview.png)

## 网站入口

- 私人空间版：<https://home.ftree.club/about>
...
- 图文操作指南：<https://github.com/mulspace/ftree/wiki/图文操作指南>
- 历史家谱示例：<https://github.com/mulspace/ftree/wiki/历史家谱示例>
...
![西汉皇帝世系完整家谱](https://raw.githubusercontent.com/mulspace/ftree/main/docs/images/western-han-family-tree-full.png)

西汉示例包含 128 个人物节点、10 个世代层级，以及帝号、谥号、爵号、人物备注和 9 个陵寝或遗址代表坐标。GPS 只用于演示公开历史地点，不表示人物住宅、出生地或活动轨迹。详细资料和坐标来源见[历史家谱示例](https://github.com/mulspace/ftree/wiki/历史家谱示例)。
...
fTree 后端负责 OAuth 和加密档案转发。应用不建立用户数据库，也不把家谱正文或用户 OAuth Token持久化到应用存储。第三方平台及网络基础设施仍可能依据各自条款处理请求元数据。
