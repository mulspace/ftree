...
报告问题时可以提供浏览器版本、操作系统、复现步骤、错误文字和脱敏截图。不得提交：
...
请先查阅仓库中的[用户操作指南](https://github.com/mulspace/ftree/blob/main/docs/USER_GUIDE.md)和[隐私说明](https://github.com/mulspace/ftree/blob/main/docs/PRIVACY.md)。
